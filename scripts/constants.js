...
export const API_VERSION = "0.7.2";
export const REQUEST_SCHEMA_VERSION = 7;
export const BLUEPRINT_SCHEMA_VERSION = 10;
...
export const CORE_AFFLICTION_LIBRARY_ID = `${MODULE_ID}.affliction-library.core`;
